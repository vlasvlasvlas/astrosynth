...
export const PLANETS = [
  { name: "Mercury", radius: 2.2, mass: 1.660e-7, note: 64, color: palette.Mercury, action: "Perihelion ping",
  ...
  { name: "Venus", radius: 3.2, mass: 2.447e-6, note: 55, color: palette.Venus, action: "Cloud veil",
  ...
  { name: "Earth", radius: 3.5, mass: 3.003e-6, note: 60, color: palette.Earth, action: "Launch probe",
  ...
  { name: "Mars", radius: 2.8, mass: 3.227e-7, note: 58, color: palette.Mars, action: "UFO swarm",
  ...
  { name: "Jupiter", radius: 7.3, mass: 9.545e-4, note: 40, color: palette.Jupiter, action: "Gravity chorus",
  ...
  { name: "Saturn", radius: 6.6, mass: 2.857e-4, note: 43, color: palette.Saturn, action: "Ring gates",
  ...
  { name: "Uranus", radius: 5.4, mass: 4.366e-5, note: 47, color: palette.Uranus, action: "Tilt drone",
